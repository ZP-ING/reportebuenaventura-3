          ...
          {notifications.length === 0 ? (
            ...
            <div className="divide-y divide-green-100">
              {notifications.map((notification) => (
                <Card
                  key={notification.id}
                  className={`p-3 m-2 cursor-pointer transition-colors border-2 hover:shadow-md ${
                    notification.read
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* Estado del reporte con color */}
                      {notification.newStatus && (
                        <div className="mb-2">
                          <Badge 
                            className={`text-xs ${STATUS_CONFIG[notification.newStatus as keyof typeof STATUS_CONFIG]?.color || 'bg-gray-100 text-gray-800'}`}
                          >
                            {STATUS_CONFIG[notification.newStatus as keyof typeof STATUS_CONFIG]?.label || notification.newStatus}
                          </Badge>
                        </div>
                      )}
