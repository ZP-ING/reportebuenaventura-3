...
export function AdminAnalytics() {
  ...
  const loadData = async () => {
    try {
      ...
      // Silently handle error - show empty state to user
  ...
  const entityPerformance = entityNames.map((entity: string) => {
    const entityReports = reports.filter(r => (r.entityName || r.entity) === entity);
    return {
      entity,
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl text-green-600 mt-1">{resolvedReports}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl text-red-600 mt-1">{rejectedReports}</p>
              </div>
