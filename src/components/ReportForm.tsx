        ...
        <CardContent className="p-8">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-6 p-8 bg-gradient-to-r from-blue-50/50 to-green-50/50 rounded-[-52px] border-2 border-blue-100">
                    ...
                    <div className="mt-6 space-y-4">
                      ...
                      <div className="bg-white p-4 rounded-lg border-2 border-green-200 flex items-center justify-between">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={removeImage}
                          className="text-red-600 hover:text-red-700 hover:bg-red-50 border-2 border-red-200 hover:border-red-300 h-9 px-3"
